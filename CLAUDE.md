...
- **2026-07-17:** **F6** contact documents (#69) built + dev-verified, NOT deployed — next step: Publish. Feature #68 Web Push follow-up closed out on prod (VAPID secrets confirmed, verified via real portal login); Android/iPhone push test still outstanding. *(full detail in CLAUDE_ARCHIVE.md)*
...
- **PD test backlog**: Done+DEPLOYED B1–2, F1–F5, #61. **F6** built + dev-verified 2026-07-17 (#69), not yet deployed. Remaining: **F7** Site Board live on-site count, **F8** Timeline programme link, **F9/F10** spikes.
