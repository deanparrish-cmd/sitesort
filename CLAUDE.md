...
- **2026-07-15 (NOT deployed — typecheck ✅, e2e 6/6 push + 360px UI ✅):** Feature **#68** portal freshness (RQ refetch/60s poll/superseded-at-open) + unseen nav badges + "Shared" NEW pills + **Web Push** (VAPID, `push_subscriptions`/`pending_pushes`, batched triggers, in-context permission card w/ iOS install-chaining, Settings toggle). **Needs: (1) user adds `VAPID_PUBLIC_KEY`/`VAPID_PRIVATE_KEY` to Replit Secrets, (2) Publish, (3) real Android+iPhone push test.**
...
- **2026-07-15 (#64/#65) & 2026-07-14 & earlier:** see CLAUDE_ARCHIVE.md.
