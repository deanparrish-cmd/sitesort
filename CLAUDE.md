...
- **2026-07-15 (NOT deployed — typecheck ✅, session e2e 7/7 ✅):** Feature **#67** portal session policy (sliding-30d/12h-inactivity/server-revoke, `portal_sessions`) + logo→home. Sharing "bug" NOT reproducible (engine verified working live). **Next: PD to Publish, then prod-verify.**
