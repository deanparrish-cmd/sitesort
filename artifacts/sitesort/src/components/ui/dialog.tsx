...
export function Dialog({ open, onOpenChange, children }: DialogProps) {
  ...
  return (
    ...
    >
      ...
      {/* Dialog */}
      <div className="z-50 w-full max-w-lg scale-100 p-2 sm:p-6 opacity-100 slide-up">
        <div className="relative flex w-full flex-col rounded-2xl border bg-background p-4 sm:p-6 shadow-2xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto">
          <button
