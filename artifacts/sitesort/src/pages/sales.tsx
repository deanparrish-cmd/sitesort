...
/**
 * Before/After comparison slider, matching the one on the main landing page.
 * Duplicated locally (rather than shared) so this page can evolve without
 * touching the existing landing page.
 */
function BeforeAfterSlider() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-y-0 w-0.5 bg-white shadow-[0_0_8px_rgba(0,0,0,0.35)]" style={{ left: `${pos}%` }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-3xl mx-auto slide-up">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-primary tracking-tight mb-8 leading-tight">
              Right drawing. Right hands. <br className="hidden sm:block" />
